...
version 2.4_mqtt
 march 2023 adding MQTT serveur, rpower and relay information are sent to MQTT every 5 minutes (same bluetooth) caution: during mqtt connection regulation is OFF! 
            not an issue in summer as power is changing slowly (no heater)
            not working! it is impossible to change wifi server without reset!
