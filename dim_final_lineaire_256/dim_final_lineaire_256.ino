...
Test to increased dim from 1 to 256; 
...
byte dimmax = 256;              // max value to start SCR command

byte dim = 0; // dim increased 0 to  256
...
char periodStep = 37;                            // 37 * 256 = 10msec, calibration using oscilloscope
