...
Test to increased dim from 0 to 3 and send a command to a serial port HC06 using JSON
...
float rPower;
float mean_power_bluetooth;
bool relay_1 = true ; // Flag relay 1
...
{
        rPower = dim;
        mean_power_bluetooth = dim /2;
        doc["sensor"] = "routeur";
        doc["mean_power"][0] = rPower;
        doc["mean_power_5mn"][0] = mean_power_bluetooth;
        doc["relay1"] = relay_1;
        doc["relay2"] = relay_2;
        Serial.println();
